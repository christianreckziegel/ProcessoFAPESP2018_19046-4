...
void resultAnalysis2(){
	...
	//double binL = hEnergy->FindBin(0.); //left far end of canvas histogram
	//double binR = hEnergy->FindBin(9.999); //right far end of canvas histogram
	...
	double incEff = eff*sqrt(TMath::Power(sqrt(eParcial)/eParcial,2) + TMath::Power(sqrt(eTotal)/eTotal,2));
