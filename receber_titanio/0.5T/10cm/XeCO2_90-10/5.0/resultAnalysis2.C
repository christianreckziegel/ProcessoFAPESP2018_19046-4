...
void resultAnalysis2(){
	...
	TString strEnergy = "5.0";
	TString strSize = "10"; //"+strSize+"
	TString strMagField = "0.5"; //"+strMagField+"
	TString strGas = "XeCO2_90-10"; //strGas+"
	TString strGasHist = "XeCO_{2} (90-10)"; //"+strGasHist
	...
	int nbinsE = 27; //27 é o ideal para 0-10GeV
