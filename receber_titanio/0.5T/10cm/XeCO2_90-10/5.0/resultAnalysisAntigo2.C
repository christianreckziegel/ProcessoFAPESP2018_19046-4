...
void resultAnalysis2(){
	...
	TString sEnergy = "5.0";
	TString strBase = "XeCO2_90-10_Result_"+sEnergy+"GeV_0.5T_10cm_";
	...
	int nbinsE = 20; //40 é o ideal para 10GeV, 21 é o ideal para 18GeV
	...
	int nbinsPoint = 30;
	TH2D* hRadPoint = new TH2D("RadiusPerPoint", "Radius per #points of fit "+sEnergy+"GeV muon under 0.5T XeCO_{2} (90-10)", 
