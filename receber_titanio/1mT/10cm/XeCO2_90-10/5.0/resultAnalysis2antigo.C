...
void resultAnalysis2(){
	...
	int nbinsR = 100; //18 é o ideal para 4600
	TH1D* hRadius = new TH1D("Radius", "Estimated radius for a "+sEnergy+"GeV muon under 0.5T XeCO_{2} (90-10)", 
				nbinsR, 
				0.0, 16000.0); //from 0 to 16000cm=160m
	...
	int nbinsE = 50; //40 é o ideal para 10GeV
	TH1D* hEnergy = new TH1D("Energy", "Estimated energy for a "+sEnergy+"GeV muon under 0.5T XeCO_{2} (90-10)", 
				nbinsE, 
				0.0, 80.0); //from 0 to 6GeV
	...
	int nbinsChi2 = 100;
	TH1D* hChi2 = new TH1D("Chi2", "#Chi^{2}_{red} of circle fit "+sEnergy+"GeV muon under 0.5T XeCO_{2} (90-10)", 
	...
	int nbinsPoint = 30;
	TH2D* hRadPoint = new TH2D("RadiusPerPoint", "Radius per #points of fit "+sEnergy+"GeV muon under 0.5T XCO_{2} (90-10)", 
				nbinsPoint, 0., 40., //nº of points of the fitting
				nbinsR, 0.0, 16000.0); //radius from 0 to 500
	...
	TH2D* hChiPoint = new TH2D("ChiPerPoint", "#Chi^{2}_{red} per #points of fit "+sEnergy+"GeV muon under 0.5T XeCO_{2} (90-10)", 
				nbinsPoint, 0., 30., //nº of points of the fitting
				nbinsChi2, 0.0, 5.0); //Chi2Red from 0 to 10
