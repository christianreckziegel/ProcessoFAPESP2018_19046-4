...
void resultAnalysis2(){
	...
	TString sEnergy = "5.0";
	TString strBase = "ArCO2_70-30_Result_"+sEnergy+"GeV_1mT_10cm_";
	...
	TH1D* hChi2Line = new TH1D("Chi2", "#Chi^{2}_{red} of straight line fit "+sEnergy+"GeV muon under 0.5T ArCO_{2} (70-30)", 
	...
	TH2D* hRadPoint = new TH2D("RadiusPerPoint", "Radius per #points of fit "+sEnergy+"GeV muon under 0.5T ArCO_{2} (70-30)", 
				...
				nbinsR, 0.0, 900000.0); //radius from 0 to 500
	hRadPoint->GetXaxis()->SetTitle("# points in the fit");
	hRadPoint->GetYaxis()->SetTitle("R(cm)");
	hRadPoint->GetZaxis()->SetTitle("Entries");
	//creating canvas and histogram for chi^2_red of circle fit
	TCanvas *cChiPoint = new TCanvas("cChiPoint","Canvas 2D radiusX#nu");
	TH2D* hChiPoint = new TH2D("ChiPerPoint", "#Chi^{2}_{red} per # of degrees of freedom of circle fit "+sEnergy+"GeV muon under 0.5T ArCO_{2} (70-30)", 
				nbinsPoint, 0., 23., //nº of degrees of freedom of the fitting
				nbinsChi2, 0.0, 7.1); //Chi2Red from 0 to 10
	hChiPoint->GetXaxis()->SetTitle("#nu");
	hChiPoint->GetYaxis()->SetTitle("#Chi^{2}_{red}");
	hChiPoint->GetZaxis()->SetTitle("Entries");
	//creating canvas and histogram for chi^2_red of straight line fit
	TCanvas *cChiPointLine = new TCanvas("cChiPointLine","Canvas 2D radiusX#nuLine");
	TH2D* hChiPointLine = new TH2D("ChiPerPoint", "#Chi^{2}_{red} per # of degrees of freedom of linear fit "+sEnergy+"GeV muon under 0.5T ArCO_{2} (70-30)", 
				nbinsPoint, 0., 23., //nº of degrees of freedom of the fitting
				nbinsChi2, 0.0, 2.5); //Chi2Red from 0 to 10
