...
void resultAnalysis2(){
	...
	TString sEnergy = "5.0";
	TString strBase = "ArCO2(70-30)Result_"+sEnergy+"GeV_5T_10cm_";
	...
	int nbinsR = 160;
	TH1D* hRadius = new TH1D("Radius", "Estimated radius for a "+sEnergy+"GeV muon under 5T ArCO_{2} (70-30)", 
				nbinsR, 
				0.0, 1000.0); //from 0 to 200cm
	...
	int nbinsE = 150;
	TH1D* hEnergy = new TH1D("Energy", "Estimated energy for a "+sEnergy+"GeV muon under 5T ArCO_{2} (70-30)", 
				nbinsE, 
				0.0, 15.0); //from 0 to 6GeV
	...
	int nbinsChi2 = 100;
	TH1D* hChi2 = new TH1D("Chi2", "#Chi^{2}_{red} of circle fit "+sEnergy+"GeV muon under 5T ArCO_{2} (70-30)", 
	...
	int nbinsPoint = 30;
	TH2D* hRadPoint = new TH2D("RadiusPerPoint", "Radius per #points of fit "+sEnergy+"GeV muon under 5T ArCO_{2} (70-30)", 
				nbinsPoint, 0., 30., //nº of points of the fitting
				nbinsR, 0.0, 1000.0); //radius from 0 to 500
	...
	TH2D* hChiPoint = new TH2D("ChiPerPoint", "#Chi^{2}_{red} per #points of fit "+sEnergy+"GeV muon under 5T ArCO_{2} (70-30)", 
				nbinsPoint, 0., 30., //nº of points of the fitting
